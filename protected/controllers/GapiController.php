...
class GapiController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Gapi');
	...
	{
		$model=new Gapi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Gapi']))
			$model->attributes=$_GET['Gapi'];
	 ...
	 * @return Gapi the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Gapi::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Gapi $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gapi-form')
		{
